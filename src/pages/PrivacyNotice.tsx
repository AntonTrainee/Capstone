...
export default function PrivacyNotice() {
  return (
    <div style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto" }}>
      ...
      <h2>2. Who we are</h2>
      <p>
        Controller: <strong>GENCLEAN INC.</strong> <br />
        Contact (Data Protection Officer or privacy contact):{" "}
        <strong>dataprotection@genclean.com.ph</strong> <br />
        Address: Unit 114, Corinthian Executive Regency, No.7 Ortigas Avenue,
      ...
      <p>
        ...
        (where applicable), and compliance with RA 10173 or the Data Privacy Act
        of 2012.
      </p>
      ...
      <ul>
        <li>
          ...
          active. After account deletion or inactivity, retained for 1 year for
          dispute resolution and fraud prevention, then deleted or anonymized.
        </li>
        <li>
          <strong>Booking records &amp; service details</strong>: kept for 3
          years for accounting/tax compliance and disputes.
        </li>
        <li>
          <strong>Support tickets &amp; communications</strong>: kept for 3
        ...
        <li>
          <strong>Analytics logs</strong>: raw logs kept for 12 months,
      ...
      <p>
        ...
        or object to processing. Contact us at{" "}
